                    ...
                    <div class="row ">
                        <div class="row">
                            ...
                            <div class="col-12 d-flex justify-content-end">
                                ...
                                <a type="button" href="{{url('admin/users')}}" class=" btn-default btn-danger"
                        ...
                        <form method="post" enctype="multipart/form-data" action="{{url('dashboard/profile')}} "
                                ...
                                <div class="row">
                                    <div class="col-md-4 mb-3">
                                        ...
                                        @if ($user_edit->Profile && isset($user_edit->Profile->profile_image))

                                        <!-- <img class=" img-fluid rounded mb-4 border border-2 border-dark shadow"
                                            src="{{ file_exists(public_path('uploads/user/'.$user_edit->Profile->profile_image)) ? asset('uploads/user/'.$user_edit->Profile->profile_image) : asset('/no-image.png') }}"> -->
                                            ...
                                            name="profile_image" onchange="loadFile(event)"  accept=".png, .jpg, .jpeg" />
                                                ...
                                                <div class="avatar-preview">
                                                    <div id="imagePreview" style="background-image: url({{ file_exists(public_path('uploads/user/'.$user_edit->Profile->profile_image)) ? asset('uploads/user/'.$user_edit->Profile->profile_image) : asset('/no-image.png') }});">
                                                    </div>
                                                </div>
                                            </div>

                                        <input type="hidden" name="old_image"
                                            value="{{$user_edit->Profile->profile_image}}" />
                                            @else
                                            <!-- <img class=" img-fluid rounded mb-4 border border-2 border-dark shadow"
                                        ...
                                        <!-- <input type="file" class="mt-4" accept="image/*" id="profile_image"
                                            ...
                                            <div class="col-md-6">
                                                <label class="default-input-field custom-input">
                                                    <input type="email" id="email"
                                                        value="{{ $user_edit->email  ?? old('email') }}" name="email"
                                                        placeholder="&nbsp;" />
                                            ...
                                            <div class="col-md-6">
                                                <label class="default-input-field custom-input">
                                                    <input type="text" id="phone" name="phone"
                                                        value="{{$user_edit->Profile->phone  ?? old('phone') }}"
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <label class="default-input-field custom-input">
                                                    <input type="text" id="company"
                                                        value="{{ $user_edit->Profile->company  ?? old('company') }}"
                                            ...
                                            <div class="col-md-6">
                                                <label class="default-input-field custom-input">
                                                    <input type="number" id="zip" name="zip"
                                                        value="{{ $user_edit->Profile->zip  ?? old('zip') }}"
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="hidden"
                                            value="{{ $user_edit->Profile->country  ?? old('country') }}"
                                            id="selected_country">
                                        <input type="hidden"
                                            value="{{ $user_edit->Profile->region  ?? old('region') }}"
                                            id="selected_region">
                                        <input type="hidden" value="{{ $user_edit->Profile->city  ?? old('city') }}"
                                            id="selected_city">
                                ...
                                <div class="mb-3">
                                    ...
                                    <label class="default-input-field custom-input">
                                        <input type="text"
                                            value="{{ $user_edit->Profile->address_line1  ?? old('address_line1') }}"
                                    ...
                                    <div class="mb-3">
                                        <label class="default-input-field custom-input" style="height:unset;">
                                            <input type="text"
                                                value="{{ $user_edit->Profile->address_line2  ?? old('address_line2') }}"
                                ...
                                <input type="hidden" class="form-control"
                                    value="{{$user_edit->id ?? 'null'}}" id="user_id" name="user_id">
                                    <input type="hidden" class="form-control"
                                    value="{{$user_edit->Profile->id ?? 'null'}}" id="profile_id" name="profile_id">
