                            ...
                            <div class="orders bg-light p-3 mb-3 rounded">
                                ...
                                <div class="row d-flex justify-content-between">
                                    <div class="col-md-7 mb-3 mb-md-0 p-2 rouded bg-orders">
                                        ...
                                        <p>
                                            <span
                                                class="bg-primary text-white rounded-pill p-1">{{$order->User->name}}</span>
                                        </p>
                                        <p><span class="small">
                                            Email: 
                                        </span>
                                    ...
                                    <div class="col-md-4 p-2 rouded bg-orders">
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                ...
                                                <p class="p-0 m-0">{{$order->shipping_cost != null ? $order->shipping_cost+$order->order_payment: $order->order_payment}} {{trans('global.currency_symbol')}}</p>
